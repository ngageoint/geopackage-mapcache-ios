...
NSString * const GPKGS_SAMPLE_RESOURCES_PROPERTIES = @"sample";
...
NSString * const GPKGS_PROP_FEATURE_TILES_DRAW_COLORS_NAME = @"name";
NSString * const GPKGS_PROP_FEATURE_TILES_DRAW_COLORS_RED = @"red";
NSString * const GPKGS_PROP_FEATURE_TILES_DRAW_COLORS_GREEN = @"green";
NSString * const GPKGS_PROP_FEATURE_TILES_DRAW_COLORS_BLUE = @"blue";
NSString * const GPKGS_PROP_FEATURE_TILES_DRAW_COLORS_ALPHA = @"alpha";
NSString * const GPKGS_PROP_FEATURE_TILES_DRAW_COLORS_WHITE = @"white";
